package com.songj.mybatis.generator;
...
/**
 * @ClassNamee: MyJavaTypeResolverDefaultImpl
 * @Description: 自定义mybatis-generator自动生成代码时的类型转换对应关系
 * JavaTypeResolver的实现类org.mybatis.generator.internal.types.JavaTypeResolverDefaultImpl负责这一部分的类型转换。
 * @Author: Scott S
